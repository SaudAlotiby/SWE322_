...
<body>
    ...
    <?php
        ...
        $course1 = new Courses();
        $course1->setCourseCode("MTH 302");
        $course1->setCourseName("Differential Equations");
        $course1->setCourseDescription("Differential Equations are the language in which the laws of nature are expressed. Understanding properties of solutions of differential equations is fundamental to much of contemporary science and engineering.");
        $course1->setGrade("A+");
		
	

        $course2 = new Courses();
        $course2->setCourseCode("SWE 321");
        $course2->setCourseName("Advanced User Interface Design");
        $course2->setCourseDescription("In this course, you will gain an understanding of the critical importance of user interface design. You will also learn industry-standard methods for how to approach the design of a user interface and key theories and frameworks that underlie the design of most interfaces you use today.");
        $course2->setGrade("A");
